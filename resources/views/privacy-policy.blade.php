...
<div class="adlance_sections_container story_details">
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-12 col-xl-10 py-5 col-xxl-8 text-left">
                <h1 class="story_title">Privacy Policy</h1>
                ...
                <ul>
                    ...
                    <li>
                        <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or
                            &quot;Our&quot; in this Agreement) refers to adlance, 171-H, 2nd Floor, Sector H Dha Phase 1, Lahore, Punjab
                            54792.</p>
                    </li>
                    <li>
                    ...
                    <li>
                        <p><strong>Website</strong> refers to adlance, accessible from <a href="http://adlance.co.uk" rel="external nofollow noopener" target="_blank">http://adlance.co.uk</a></p>
                    </li>
                    <li>
                ...
                <p>You may also have the option of sharing additional information with the Company through Your Third-Party Social Media
                    Service's account. If You choose to provide such information and Personal Data, during registration or otherwise, You
                    are giving the Company permission to use, share, and store it in a manner consistent with this Privacy Policy.</p>
                ...
                <ul>
                    ...
                    <li><strong>With other users:</strong> when You share personal information or otherwise interact in the public areas
                        ...
                        Social Media Service may see Your name, profile, pictures and description of Your activity. Similarly, other users
                ...
                <ul>
                    <li>
                        <p>By email: info@adlance.co.uk</p>
                    </li>
                    <li>
                        <p>By visiting this page on our website: <a href="/contact-us" rel="external nofollow noopener" target="_blank">http://adlance.co.uk/contact</a></p>
                    </li>
                    <li>
                        <p>By phone number: +92321 7340568</p>
                    </li>
                    <li>
                        <p>By mail: 171-H, 2nd Floor, Sector H Dha Phase 1, Lahore, Punjab 54792</p>
                    </li>
                </ul>


                <!-- <img class="w-100 my-5" src="assets/images/ethical-popup.jpg" alt="" /> -->
